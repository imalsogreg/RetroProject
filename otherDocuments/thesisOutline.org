...
A brief reveiw of cellular organization in the hippocampus is given to help the reader stay oriented during discussions of electrode placement and traveling wave propagation. We also describe the common hippocampal field potential and basic spiking patterns of excitatory neurons in freely-moving rats, which are central to the rest of the thesis.
...
The first sheet fold described above divides the /proximal-distal axis/ into two parts, CA3 and CA1 (CA comes from /cornu ammonis/, "ram's horn", due to the 
