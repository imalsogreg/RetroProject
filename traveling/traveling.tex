...
Along the CA1 septal-temporal axis, and between CA1 and CA3, spatial information content is synchronized to within 5 ms, despite a time offset in theta on the order of 30 ms. Rather than causing different areas to repsesent different parts of a track at the same time, offsets in excitability manifest as a subtle tendency for different brain areas to be more active at different phases of the theta cycle.
