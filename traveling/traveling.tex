...
Models that explain place cell phase precession mechanistically in terms of the excitation produced by the theta rhythm would expect results different from ours.
